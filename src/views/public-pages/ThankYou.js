            ...
            <div className='row' style={{ paddingBottom: "3rem" }}>
              <div className='socialLink d-flex align-items-center gap-3 justify-content-center'>
                <a className="socialLinkItem fillLink">
                  <FacebookShareButton
                    url={`${process.env.REACT_APP_FYS_APP_URL}/donations/${donation_slug}/thank-you${shareUrl}`}
                    quote={`Your Donation of ${amount}.00 has been Processed!`}
                ...
                <a className="socialLinkItem strokeLink">
                  ...
                  <TwitterShareButton
                    url={`${process.env.REACT_APP_FYS_APP_URL}/donations/${donation_slug}/thank-you${shareUrl}`}
                    title={`Your Donation of ${amount}.00 has been Processed!`}
                    className="Demo__some-network__share-button"
                  >
                ...
                <a  className="socialLinkItem strokeLink">
                  <EmailShareButton
                    url={`${process.env.REACT_APP_FYS_APP_URL}/donations/${donation_slug}/thank-you${shareUrl}`}
                    subject={`Your Donation of ${amount}.00 has been Processed!`}
                    body="body"
                    className="Demo__some-network__share-button"
                  >

            ...
            <div id='landingpage'>
                <div id='banner' className='myComponent'>
                    ...
                    <Row>
                        ...
                        <img src={require('@src/assets/images/public_pages/avatar_big.png').default} className='myCenter avatar'></img>
                        </Col>
                        <Col md="9">
                        <div>
                            <h1 className="fs-48 fw-bold text-clr-black">Brooklyn Simmons</h1>
                            <p className="fs-5 text-clr-black fw-bold">Athletic Club</p>
                        </div>
                        <div>
                            <h4 className="text-clr-blue fs-30 fw-semibold mt-4 pt-2 description">$200 Raised for</h4>
                            <p className="fs-5 fw-bold text-clr-black">Valley Athletics Club held a charity fundraising event</p>
                        </div>
                        </Col>
                    </Row>
                    </Container>
                </div>
                <div className="container progressBarContent" style={{marginTop: "-5rem"}}>
                    <div className="px-5 py-4 is-radius-8 bg-white  is-shadow1 ">
                        <div className="row gx-0 align-items-center">
                            <div className="col-lg-10 mb-lg-0 mb-4 pe-5">
                                <div className="d-flex progressBar flex-wrap align-items-center justify-content-between gap-2 mb-3">
                                    <div className="rangeFrom mb-0 text-clr-black fs-18 fw-bold">$200</div>
                                    <div className="rangeTo d-flex align-items-center gap-2"><p className="mb-0 text-clr-black fs-18 fw-bold">2%</p><span className="mb-0 text-clr-black fs-18 fw-bold">/</span><p className="mb-0 text-clr-black fs-18 fw-bold">$5000</p></div>
                                </div>
                            ...
                            <div className="col-lg-2"><a className="bg-primary text-nowrap px-4 py-2 text-decoration-none is-radius-8 fs-6 fw-bold text-white d-inline-flex text-center donate_btn" href="/public/donationform">Donate Now<span><svg className="mb-1" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.92505 16.6L13.3584 11.1667C14 10.525 14 9.475 13.3584 8.83334L7.92505 3.4" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path></svg></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div id="description" className='myComponent'>
                    ...
                    <Row className='title'>
                        ...
                        <h1 className='myCenter'>Why am I Fundraising</h1>
                        </div>
                    </Row>
                    <Row className='content'>
                        <p className="fs-22 text-clr-gray fw-500">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Pellentesque vulputate quam a quam volutpat, sed ullamcorper erat commodo. Vestibulum sit amet ipsum vitae mauris mattis vulputate lacinia nec neque. Aenean quis consectetur nisi, ac interdum elit. Aliquam sit amet luctus elit, id tempus purus.</p>
                    </Row>
                    <Row>
                        <div className="memberSocial mt-4 mb-5">
                        <div className="social-title d-flex align-items-center justify-content-center gap-2">
                ...
                <div id="team" className='myComponent'>
                    <Container fluid="md">
                    <Row className='title'>
                        <div className='myFlex'>
                        <h1 className='myCenter'>My Team</h1>
                        </div>
                    </Row>
                    <Row>
                        <Col md="4">
                        <div className="teamitem px-4 py-4 bg-white is-radius-8">
                            <div className="d-flex align-items-center gap-3">
                            <div>
                                <img src={require('@src/assets/images/public_pages/teams/team1.svg').default} alt=""></img>
                            </div>
                            <div>
                                <h5 className="fs-24 fw-bold text-clr-black">Rumbled Rockers</h5>
                                <p className="fs-18 fw-semibold text-clr-black mb-0">$200 to $5000</p>
                            </div>
                            </div>
                        </div>
                        </Col>
                        ...
                        <div className="teamitem px-4 py-4 bg-white is-radius-8">
                            <div className="d-flex align-items-center gap-3">
                            <div>
                                <img src={require('@src/assets/images/public_pages/teams/team2.svg').default} alt=""></img>
                            </div>
                            <div>
                                <h5 className="fs-24 fw-bold text-clr-black">Mister Maniacs</h5>
                                <p className="fs-18 fw-semibold text-clr-black mb-0">$100 to $2000</p>
                            </div>
                            </div>
                        </div>
                        </Col>
                        ...
                        <div className="teamitem px-4 py-4 bg-white is-radius-8">
                            <div className="d-flex align-items-center gap-3">
                            <div>
                                <img src={require('@src/assets/images/public_pages/teams/team3.svg').default} alt=""></img>
                            </div>
                            <div>
                                <h5 className="fs-24 fw-bold text-clr-black">Rule Breakers</h5>
                                <p className="fs-18 fw-semibold text-clr-black mb-0">$200 to $4000</p>
                            </div>
                            </div>
                        </div>
                        </Col>

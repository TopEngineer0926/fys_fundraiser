                        ...
                        <Container fluid="md" className='container'>
                            <div className='row'>
                                <div className='col-md-3 myFlex'>
                                    <img src={fundraiser?.avatar || defaultAvatar} style={{ height: "250px", width: "300px", objectFit: "cover" }} className='myCenter'></img>
                                </div>
                            ...
                            <div className='row' style={{ paddingBottom: "3rem" }}>
                                <div className='socialLink d-flex align-items-center gap-3 justify-content-center'>
                                    ...
                                    <a className="socialLinkItem fillLink">
                                        <FacebookShareButton
                                            url={`${process.env.REACT_APP_FYS_APP_URL}/fundraisers/${fundraiser_slug}`}
                                            quote={`Help support ${fundraiser?.firstName} ${fundraiser?.lastName}`}
                                    ...
                                    <a className="socialLinkItem strokeLink">
                                        ...
                                        <TwitterShareButton
                                            url={`${process.env.REACT_APP_FYS_APP_URL}/fundraisers/${fundraiser_slug}`}
                                            title={`Help support ${fundraiser?.firstName} ${fundraiser?.lastName}`}
                                            className="Demo__some-network__share-button"
                                        >
                                    ...
                                    <a className="socialLinkItem strokeLink">
                                        <EmailShareButton
                                            url={`${process.env.REACT_APP_FYS_APP_URL}/fundraisers/${fundraiser_slug}`}
                                            subject={`Help support ${fundraiser?.firstName} ${fundraiser?.lastName}`}
                                            body={fundraiser?.campaign?.shortDescription}
                                            className="Demo__some-network__share-button"
                                        >

                                ...
                                <div className='myLeft' style={{ marginLeft: "2rem" }}>
                                    ...
                                    <div className='myFlex' style={{ paddingBottom: "2rem" }}>
                                        <h3 className="myLeft" style={{ fontWeight: "bold", color: "blue" }}>
                                            ...
                                            ${team?.campaign?.currentDonations} raised towards my goal of ${team?.campaign?.goalAmount}
                                         {/* Raised for */}
                                         </h3>
                                    </div>
                                ...
                                <div className='row' style={{ paddingBottom: "1.5rem" }}>
                                    <div className='col-md-4'>
                                        ...
                                        <div className='myFlex content'>
                                            <h2 className='myCenter'>{team?.campaign?.currentDonors || 0}</h2>
                                        </div>
                                    </div>
                                    <div className='col-md-4'>
                                        <div className='myFlex title'>
                                        ...
                                        <div className='myFlex content'>
                                            <h2 className='myCenter'>${team?.campaign?.averageDonation || 0}</h2>
                                        </div>
                                    </div>
                                    <div className='col-md-4'>
                                        <div className='myFlex title'>
                                        ...
                                        <div className='myFlex content'>
                                            <h2 className='myCenter'>${team?.campaign?.currentDonations || 0}</h2>
                                        </div>
                                    </div>
                                </div>
                                <div>
